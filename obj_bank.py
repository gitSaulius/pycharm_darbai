...
# class Bankas:
# # kuriam konstruktoriu
#     def __init__(self):
#         # sukuriamas tuscias masyvas (listas), kuriame talpinsime visas banko saskaitas
#         self.saskaitos = []
#
...
#             # iteruosime visas saskaitas ir atrasime musu saskaita kurioje norime padidinti balansas
...
#         for saskaita in self.saskaitos:
#             if saskaita["numeris"] == saskaitos_numeris:
#                 print(f"Saskaitos Balansas: {saskaita['balansas']} eur")
#                 break
#         else:
#             print("Nepavyko rasti saskaitos su nurodytu numeriu!")
# # sukuriame objekta
